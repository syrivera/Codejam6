...
public class MealsFunctions
{
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "meals/search")] HttpRequestData req)
    {
        ...
        var results = await _db.Meals
            .Where(m => m.Name.ToLower().Contains(nameLower))
        ...
        await JsonSerializer.SerializeAsync(ok.Body, results, new JsonSerializerOptions(JsonSerializerDefaults.Web));
        ok.Body.Position = 0;
        return ok;
    }
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "meals")] HttpRequestData req)
    {
        ...
        await JsonSerializer.SerializeAsync(created.Body, meal, new JsonSerializerOptions(JsonSerializerDefaults.Web));
        created.Body.Position = 0;
        return created;
    }
}
